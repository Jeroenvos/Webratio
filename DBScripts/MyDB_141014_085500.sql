...
alter table `annotation`  add column  `item_oid`  integer;
alter table `annotation`   add index fk_annotation_item (`item_oid`), add constraint fk_annotation_item foreign key (`item_oid`) references `item` (`oid`);
